...
public class GamePanel extends JPanel implements Runnable {
    ...
    public double scaleX = 1.5, scaleY = 1.5;
    ...
    protected void paintComponent(Graphics g2) {
        ...
        if (showInfo) {
            ...
            g2.drawString("FPS: " + drawFPS, (int) (10 * scaleX), (int) (20 * scaleY));
            g2.drawString("SCALE X: " + scaleX, (int) (10 * scaleX), (int) (40 * scaleY));
            g2.drawString("SCALE Y: " + scaleY, (int) (10 * scaleX), (int) (60 * scaleY));
            g2.drawString("WIDTH: " + screenWidth, (int) (10 * scaleX), (int) (80 * scaleY));
            g2.drawString("HEIGHT: " + screenHeight, (int) (10 * scaleX), (int) (100 * scaleY));
            g2.drawString("WORLD WIDTH: " + worldWidth, (int) (10 * scaleX), (int) (120 * scaleY));
            g2.drawString("WORLD HEIGHT: " + worldHeight, (int) (10 * scaleX), (int) (140 * scaleY));
            g2.drawString("OBJECTS: " + map.getGameObjects().size(), (int) (10 * scaleX), (int) (160 * scaleY));
