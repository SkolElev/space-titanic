...
public class GraphicsLoader {
    ...
    public BufferedImage[] ammoImages, bulletImages;
    ...
    public GraphicsLoader(GamePanel gamePanel) {
        ...
        try {
            ...
            ammoImages = spriteSheetLoader(7,27,3,4,"screen/bullets_7x27.png");
            bulletImages = spriteSheetLoader(6,3,3,4,"ships/weapons/bullets_6x3.png");
            loadScreenImages();
        } catch (IOException e) {
